const Description = () => {
  return (
    <div className="relative md:bg-white bg-transparent md:bg-opacity-60 flex flex-col md:w-96 h-fit gap-10 justify-center items-center text-neutral-600 rounded-3xl p-5 font-semibold">
      ...
      <button className="md:bg-blue-950 bg-yellow-400 md:shadow-l shadow-[0px_2px_2px_rgba(0,0,0,0.3)] md:p-4 p-3 w-5/6 h-fit md:rounded-xl rounded-full md:text-sm text-l md:text-neutral-100 text-neutral-600">
        РЕГИСТРИРАЙТЕ СЕ
      </button>
    </div>
  );
